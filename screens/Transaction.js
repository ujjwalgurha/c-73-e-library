...
import {View,StyleSheet,TextInput,TouchableOpacity,Text,ImageBackground,Image,Alert,ToastAndroid,KeyboardAvoidingView,} from 'react-native';
import * as Permissions from 'expo-permissions';
import { BarCodeScanner } from 'expo-barcode-scanner';
import db from '../config';
import {collection,query,where,getDocs,Timestamp,limit,addDoc,doc,updateDoc,increment,} from 'firebase/firestore';
...
export default class TransactionScreen extends Component {
	...
	checkStudentEligibilityForBookIssue = async (studentId) => {
		 ...
		 if (studentRef.docs.length == 0) {
			...
			Alert.alert("The Student Doesn't Exist")
			...
			studentRef.forEach((doc) => {
				if(doc.data().number_of_books_issued <2){
					...
					Alert.alert("This Student Already Issue 2/TWO Books")
					this.setState({
						bookId:'',
						studentId:''
					})
